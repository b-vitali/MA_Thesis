...
\end{itemize}
\begin{center}
\only<1>{\includegraphics[width=0.8\textwidth]{plots/flat/TimeClusterPar_ProtonPeaks}}
\only<2>{\includegraphics[width=0.8\textwidth]{plots/flat/TimeClusterPar_ProtonPeaks_boxes}}
\end{center}
\end{frame}
